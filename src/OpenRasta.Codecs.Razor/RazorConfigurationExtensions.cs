namespace OpenRasta.Codecs.Razor
{
    ...
    public static class RazorConfigurationExtensions
    {
        ...
        /// </summary>
        public static ICodecDefinition RenderedByRazor(
            this ICodecParentDefinition codecParentDefinition, string pageVirtualPath)
        {
        ...
        /// </summary>
        public static ICodecDefinition RenderedByRazor(
            this ICodecParentDefinition codecParentDefinition, object viewVirtualPaths)
        {
        ...
        {
            uses.Resolver.AddDependencyInstance(
                typeof(IViewProvider), new EmbeddedViewProvider(assembly, baseNamespace));
        }
    }
}